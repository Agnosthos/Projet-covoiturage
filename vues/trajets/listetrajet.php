			...
			<div class="col-md-4">
				<div class="card " style="margin-top:20px;">
					<div class="card-body">
						...
						echo "<p class='card-text' style='height:45px';> Lieu de départ : ".htmlspecialchars_decode($untrajet['Lieudep'])."</p>";
						echo "<p class='card-text' style='height:45px';> Lieu d'arrivée : ".htmlspecialchars_decode($untrajet['Lieuarr'])."</p>";
						...
						else{echo "<p class='card-text' style='height:25px';><a href='index.php?ctl=trajet&action=reservationcov&idcov=".$untrajet['idcov']."&cond=".$untrajet['iduscov']."&iduser=".$_SESSION['id']."&statut=attente'>Réservation</a></p>";}}
