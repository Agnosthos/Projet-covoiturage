...
--
-- Client :  localhost
-- Généré le :  Ven 01 Avril 2022 à 10:00
...
(4, '2022-03-15', 'Aéroport Nice Côte d\'Azur (NCE), Rue Costes et Bellonte, Nice, France', 'Marseille Vieux Port, Rue Fortia, Marseille, France', 5, 'martin', 17, 63145),
(7, '2022-03-16', 'Lierganes, Paseo Hombre Pez, Liérganes, Espagne', 'dbjets.com, Kolivery Village, Kalina, Santacruz E, Bombay, Maharashtra, Inde', 3, '406', 17, 63112),
(8, '2022-03-31', 'Paris Las Vegas, South Las Vegas Boulevard, Las Vegas, Nevada, États-Unis', 'Paris Expo Porte de Versailles, Place de la Porte de Versailles, Paris, France', 3, 'martin', 17, 1205);
...
CREATE TABLE `reservation` (
  ...
  `id_cov` int(30) NOT NULL,
  `id_utilisateur` int(30) NOT NULL,
  `Lieudep` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `Lieuarr` varchar(100) CHARACTER SET utf8 NOT NULL,
  `idcond` int(100) NOT NULL,
  `Choix` text CHARACTER SET utf8
...
--
ALTER TABLE `cov`
  MODIFY `idcov` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
